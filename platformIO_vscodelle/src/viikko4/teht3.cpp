...
// int sensorPin = A7;    // Määritellään analogisen anturin nastaksi A7.
...
// void loop()
// {
//   uint16_t sensorValue = ADC_read(A7);  // Luetaan anturin arvo käyttämällä ADC_read-funktiota ja tallennetaan sensorValueen.
...
//   // MUX2, MUX1, MUX0: Valitaan analoginen kanava A7 (0000111).
